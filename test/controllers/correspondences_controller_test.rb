...
class CorrespondencesControllerTest < ActionController::TestCase
  ...
  test "should create correspondence" do
    assert_difference('Correspondence.count') do
      post :create, correspondence: { category_id: @correspondence.category_id, descripcion: @correspondence.descripcion, estado: @correspondence.estado, fin: @correspondence.fin, inicio: @correspondence.inicio, titulo: @correspondence.titulo, user_id: @correspondence.user_id }
    end
  ...
  test "should update correspondence" do
    patch :update, id: @correspondence, correspondence: { category_id: @correspondence.category_id, descripcion: @correspondence.descripcion, estado: @correspondence.estado, fin: @correspondence.fin, inicio: @correspondence.inicio, titulo: @correspondence.titulo, user_id: @correspondence.user_id }
    assert_redirected_to correspondence_path(assigns(:correspondence))
  end
